...
straight_flush = Rank.create({
                                hand_name: 'Straight Flush',
                                rank: 1
                              })

four_of_a_kind = Rank.create({
                                hand_name: 'Four of a Kind',
                                rank: 2
                              })

full_house = Rank.create({
...
straight = Rank.create({
                          hand_name: 'Straight',
                          rank: 5
                        })

three_of_a_kind = Rank.create({
                                 hand_name: 'Three of a Kind',
                                 rank: 6
                               })

two_pair = Rank.create({
                          hand_name: 'Two Pair',
                          rank: 7
                        })
